...
desc "Create _site and deploy to Cloud Foundry"
task :deploy do
  sh "jekyll build ./_site"
  sh "rm _site/*file _site/Gemfile.lock"
  sh "touch _site/Staticfile"
  sh "cf t -o starkandwayne -s production && cf push"
end
